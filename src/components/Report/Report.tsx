...
export function Report () {
    ...
    return (
        <div>
            ...
            <div className='card w-80 mt-3 rounded-xl bg-neutral-200 shadow-xl'>
                ...
                <span className='mt-1 font-medium text-base ml-1'>Ubique el lugar del incidente</span>
                <button className='btn btn-square rounded-xl btn-sm ml-2 bg-neutral-300'>
