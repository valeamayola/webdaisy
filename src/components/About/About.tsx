...
export function About() {
    ...
    return (
        ...
        <div className='flex flex-col'>
            <span className='mb-5 font-medium text-xl'>ACERCA DE</span>
            <button className='btn btn-wide mb-5'>Política de privacidad</button>
            <button className='btn btn-wide mb-5'>Términos y condiciones</button>
        </div>
        </div>
    )
}